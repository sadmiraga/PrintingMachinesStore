...
<div class="content">
    <div class="search-container-warp">
        {!! Form::open(['url'=>'/search', 'method'=> 'post' , 'enctype'=> 'multipart/form-data', 'class'=>'search-container', 'id'=>'searchForm']) !!}
            ...
            <div class="panel-group" id="accordion">
                ...
                <div class='container-fluid'>
                    <div class='row'>
                        ...
                        <div onclick="window.location.href='/productInfo/{{$machine->id}}'" id="productCard" class="card col-md-3" style="width: 18rem;">
                            <img class="categories-img" style="object-fit: cover;" height="200" width="500" src="images\machines\{{$image->image}}">
                            <div class="card-body">
